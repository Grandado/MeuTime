export const CountriesDB = [
  ...
  },
  {
    name: 'Belize',
    code: 'BZ',
    flag: 'https://media-2.api-sports.io/flags/bz.svg',
  },
  {
    name: 'Benin',
    code: 'BJ',
  ...
  },
  {
    name: 'Congo-DR',
    code: 'CG',
    flag: 'https://media-1.api-sports.io/flags/cg.svg',
  },
  {
    name: 'Costa-Rica',
    code: 'CR',
  ...
  },
  {
    name: 'Cuba',
    code: 'CU',
    flag: 'https://media-1.api-sports.io/flags/cu.svg',
  },
  {
    name: 'Curacao',
    code: 'CW',
    flag: 'https://media-2.api-sports.io/flags/cw.svg',
  },
  {
    name: 'Cyprus',
    code: 'CY',
  ...
  },
  {
    name: 'Eswatini',
    code: 'SZ',
    flag: 'https://media-2.api-sports.io/flags/sz.svg',
  },
  {
    name: 'Ethiopia',
    code: 'ET',
  ...
  },
  {
    name: 'Fiji',
    code: 'FJ',
    flag: 'https://media-1.api-sports.io/flags/fj.svg',
  },
  {
    name: 'Finland',
    code: 'FI',
  ...
  },
  {
    name: 'Gambia',
    code: 'GM',
    flag: 'https://media-1.api-sports.io/flags/gm.svg',
  },
  {
    name: 'Georgia',
    code: 'GE',
  ...
  },
  {
    name: 'Ghana',
    code: 'GH',
    flag: 'https://media-1.api-sports.io/flags/gh.svg',
  },
  {
    name: 'Gibraltar',
    code: 'GI',
  ...
  },
  {
    name: 'Haiti',
    code: 'HT',
    flag: 'https://media-1.api-sports.io/flags/ht.svg',
  },
  {
    name: 'Honduras',
    code: 'HN',
  ...
  },
  {
    name: 'Ireland',
    code: 'IE',
    flag: 'https://media-3.api-sports.io/flags/ie.svg',
  },
  {
    name: 'Israel',
    code: 'IL',
  ...
  },
  {
    name: 'Ivory-Coast',
    code: 'CI',
    flag: 'https://media-3.api-sports.io/flags/ci.svg',
  },
  {
    name: 'Jamaica',
    code: 'JM',
  ...
  },
  {
    name: 'Japan',
    code: 'JP',
    flag: 'https://media-2.api-sports.io/flags/jp.svg',
  },
  {
    name: 'Jordan',
    code: 'JO',
    flag: 'https://media-3.api-sports.io/flags/jo.svg',
  },
  {
    name: 'Kazakhstan',
    code: 'KZ',
  ...
  },
  {
    name: 'Kuwait',
    code: 'KW',
    flag: 'https://media-2.api-sports.io/flags/kw.svg',
  },
  {
    name: 'Kyrgyzstan',
    code: 'KG',
  ...
  },
  {
    name: 'Liberia',
    code: 'LR',
    flag: 'https://media-1.api-sports.io/flags/lr.svg',
  },
  {
    name: 'Libya',
    code: 'LY',
    flag: 'https://media-1.api-sports.io/flags/ly.svg',
  },
  {
    name: 'Liechtenstein',
    code: 'LI',
    flag: 'https://media-3.api-sports.io/flags/li.svg',
  },
  {
    name: 'Lithuania',
    code: 'LT',
  ...
  },
  {
    name: 'Macedonia',
    code: 'MK',
    flag: 'https://media-2.api-sports.io/flags/mk.svg',
  },
  {
    name: 'Malawi',
    code: 'MW',
  ...
  },
  {
    name: 'Mexico',
    code: 'MX',
    flag: 'https://media-2.api-sports.io/flags/mx.svg',
  },
  {
    name: 'Moldova',
    code: 'MD',
  ...
  },
  {
    name: 'Mongolia',
    code: 'MN',
    flag: 'https://media-2.api-sports.io/flags/mn.svg',
  },
  {
    name: 'Montenegro',
    code: 'ME',
    flag: 'https://media-2.api-sports.io/flags/me.svg',
  },
  {
    name: 'Morocco',
    code: 'MA',
  ...
  },
  {
    name: 'Nigeria',
    code: 'NG',
    flag: 'https://media-2.api-sports.io/flags/ng.svg',
  },
  {
  ...
  },
  {
    name: 'Palestine',
    code: 'PS',
    flag: 'https://media-1.api-sports.io/flags/ps.svg',
  },
  {
    name: 'Panama',
    code: 'PA',
  ...
  },
  {
    name: 'Paraguay',
    code: 'PY',
    flag: 'https://media-3.api-sports.io/flags/py.svg',
  },
  {
    name: 'Peru',
    code: 'PE',
  ...
  },
  {
    name: 'Philippines',
    code: 'PH',
    flag: 'https://media-2.api-sports.io/flags/ph.svg',
  },
  {
    name: 'Poland',
    code: 'PL',
  ...
  },
  {
    name: 'Slovenia',
    code: 'SI',
    flag: 'https://media-2.api-sports.io/flags/si.svg',
  },
  {
    name: 'Somalia',
    code: 'SO',
    flag: 'https://media-1.api-sports.io/flags/so.svg',
  },
  {
    name: 'South-Africa',
    code: 'ZA',
  ...
  },
  {
    name: 'Sudan',
    code: 'SD',
    flag: 'https://media-1.api-sports.io/flags/sd.svg',
  },
  {
    name: 'Surinam',
    code: 'SR',
    flag: 'https://media-3.api-sports.io/flags/sr.svg',
  },
  {
    name: 'Sweden',
    code: 'SE',
  ...
  },
  {
    name: 'Uganda',
    code: 'UG',
    flag: 'https://media-2.api-sports.io/flags/ug.svg',
  },
  {
    name: 'Ukraine',
    code: 'UA',
  ...
  },
  {
    ...
    code: 'AE',
    flag: 'https://media-1.api-sports.io/flags/ae.svg',
  },
  {
    name: 'Uruguay',
    code: 'UY',
  ...
  },
  {
    name: 'Uzbekistan',
    code: 'UZ',
    flag: 'https://media-1.api-sports.io/flags/uz.svg',
  },
  {
    name: 'Venezuela',
    code: 'VE',
    flag: 'https://media-3.api-sports.io/flags/ve.svg',
  },
  {
    name: 'Vietnam',
    code: 'VN',
    flag: 'https://media-1.api-sports.io/flags/vn.svg',
  },
  {
    name: 'Wales',
    code: 'GB',
